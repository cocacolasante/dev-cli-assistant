...
func PrintHelpMenu() {
	...
	fmt.Println("--------------------------------------------------------------------------")
	fmt.Println(" ")
	fmt.Printf("             HTTP REQUEST COMMANDS\n")
	fmt.Println("--------------------------------------------------------------------------")
	fmt.Println(" ")
	fmt.Printf("-http              flag to trigger http request\n")
	fmt.Printf("-url               url to make request to\n")
	fmt.Printf("-api               api key for request\n")
	fmt.Printf("-method            method for http request\n")
	fmt.Println("--------------------------------------------------------------------------")
	fmt.Println(" ")
